...
const Footer = () => {
  return (
    <footer className="bg-footer-bg font-proxima pt-16 pb-8">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="font-proxima text-[12px] text-heading-text mb-4">Since the 1500s, when an unknown printer took a galley of type and scrambled.</p>
        ...
        <div className="border-t border-slate-300 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
          ...
          <div className="flex items-center space-x-2">
            <Image src="/payment-amex.svg" alt="Amex" width={40} height={25} />
